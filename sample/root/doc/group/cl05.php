            ...
            <table width=95% border=0 cellspacing=0 cellpadding=2>
             ...
             <tr>
              ...
              <tr>
                <td>検索する</td>
                <td align=center>
<form action="cl05.php" method=get name=form2>
...
<input type=hidden name=text         value="<?evf("text");?>">
                  ...
                  <form action="cl05.php" method=get name=form1>
                    <input type=hidden name=mode value=find>
...
?>
<tr>
  <td width=330><a href="cl02.php?index=<?echo $data->index?>"
	      ...
	      <td colspan=2><font color=gray><? if(!$is_newest)
		    ...
		    if(!$is_newest) echo "</a>"?></font>
	         | <font color=gray><? if(!$first_page)
                  ...
                  前の5件へ<? if(!$first_page) echo "</a>"; ?></font>
                 | <font color=gray><? if(!$last_page)
                     echo "<a href=\"javascript:
                               document.form2.page.value=".($page + 1).";
		               document.form2.submit();\">";?>次の5件へ
