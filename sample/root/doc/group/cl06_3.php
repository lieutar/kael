...
<form action=cl06.php method=post enctype="multipart/form-data">
        ...
        <tr> 
          <td align="center"> 
            ...
            <table width=95% cellspacing=0 cellpadding=2>
              <tr> 
                <td width=25% nowrap
                  ><a href="cl06.php?year=<?evf("year")?>&mon=<?evf("mon")?>"
                  >社内スケジュール</a></td>
                <th width=50% nowrap>　
            ...
            <table width=95% border=0 cellspacing=0 cellpadding=2>
              <tr> 
                <td colspan=2><b><a href="cl03.php">最新記事一覧</a></b><a href="cl03.php"> 
                  </a>
                  <hr noshade size="1">
                </td>
              </tr>
...
?>
            ...
            <table width=100%>
              <tr> 
                ...
                <td align=center width=33%><a href="cl06.php">[ログイン画面]</a></td>
